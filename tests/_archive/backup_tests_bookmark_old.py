...
class BookmarkAPITestCase(APITestCase):
    ...
    def setUpTestData(cls):
        """Create test users, resources, and sample bookmarks"""
        ...
        cls.bookmark2 = Bookmark.objects.create(
            user=cls.user_2, resource=cls.resource2
        )
    ...
    def test_create_bookmark_success(self):
        ...
        new_resource = ResourceItem.objects.create(
            title="New Resource", user=self.user_1
        )
    ...
    def test_ordering_by_created_at(self):
        ...
        self.assertEqual(created_at_list, sorted(
    ...
    def test_disallowed_update(self):
        ...
        response = self.client.patch(
            self.url_detail, {"resource": self.resource.id}
        )
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
